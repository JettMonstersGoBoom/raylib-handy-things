...
static void InitLogoScreen(void)
{
    finishScreen = 0;
    framesCounter = 0;
    lettersCount = 0;
...
static void DrawLogoScreen(void)
{
...
static void UnloadLogoScreen(void)
{
    // Unload LOGO screen variables here!
}

// Logo Screen should finish?
static Screen *FinishLogoScreen(void)
{
    if (finishScreen == 1)
        return &TitleScreen;
    return NULL;
...
Screen LogoScreen =
{
    .Init = InitLogoScreen,
    .Draw = DrawLogoScreen,
    .Finish = FinishLogoScreen,
    .Unload = UnloadLogoScreen,
    .Update = UpdateLogoScreen
};
